...
Background:
  ...
  Scenario: Check of compliance of the menu to a day of the week.
     ...
     Then I see the menu:Салат Цезарь 82.54 р., Суп-пюре из Брокколи 130 р., Рагу из свинтны 250 р., Хлеб 1 р.
  ...
  Scenario: In the history of orders it is correctly displayed days of which menu this order was made.
    ...
    Then I see in history the following line:"понедельник, "<order time>" яичница из двух яиц. Списано с личного счета 20 р."