#TODO: Equal with step.rb
#TODO: For all use reformat code
...
#  reopen = @driver.find_element(:id, "days")#(:link, op).click()
...
#  #@driver.find_element(:id,"validation").displayed?
#  @driver.find_element(:id,"validation").text.should==text
#
#end
#
...
#end
#
#Then /^In the history there shall be only one record$/ do
##  @driver.find_element(:id,"history").text.should==
#end
#
